...
describe('StreamDeck', () => {
	...
	test('down and up events', () => {
		...
		expect(downSpy).toHaveBeenNthCalledWith(1, {
			...
			hidIndex: 0,
			id: 'button-4',
			bounds: { x: 399, y: 5, width: 72, height: 72 },
			index: 4,
			row: 0,
			type: 'button',
			pixelSize: {
		...
		expect(downSpy).toHaveBeenNthCalledWith(2, {
			...
			hidIndex: 6,
			id: 'button-8',
			bounds: { x: 302, y: 102, width: 72, height: 72 },
			index: 8,
			row: 1,
			type: 'button',
			pixelSize: {
...
describe('StreamDeck Mini', () => {
	...
	test('down and up events', () => {
		...
		expect(downSpy).toHaveBeenNthCalledWith(1, {
			...
			hidIndex: 0,
			id: 'button-0',
			bounds: { x: 14, y: 26, width: 80, height: 80 },
			index: 0,
			row: 0,
			type: 'button',
			pixelSize: {
...
describe('StreamDeck XL', () => {
	...
	test('down and up events', () => {
		...
		expect(downSpy).toHaveBeenNthCalledWith(1, {
			...
			hidIndex: 0,
			id: 'button-0',
			bounds: { x: 14, y: 47, width: 96, height: 96 },
			index: 0,
			row: 0,
			type: 'button',
			pixelSize: {
...
describe('StreamDeck Original V2', () => {
	...
	test('down and up events', () => {
		...
		expect(downSpy).toHaveBeenNthCalledWith(1, {
			...
			hidIndex: 0,
			id: 'button-0',
			bounds: { x: 11, y: 5, width: 72, height: 72 },
			index: 0,
			row: 0,
			type: 'button',
			pixelSize: {
